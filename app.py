...
def decode_auth_token(auth_token):
    ...
    decoded_key = jwt.decode(auth_token, jwt_secret_key, algorithms='HS256')
    pass
...
def encode_auth_token(user_id, name, email, scopes):
    ...
    encoded_key = jwt.encode(payload, jwt_secret_key, algorithms = 'HS256').decode('utf-8')
    return encoded_key
...
def login():
    ...
    name = user['name']
    token = encode_auth_token(user_id, name, email, scopes)
